...
{
    public class ControllerRepoService
    {
        ...
        public static List<string> Process(TypeDefinitionInfo typeDefinitionInfo, GeneratorContext generatorContext, AttributeMetaDataRepoController data)
        {
            ...
            ApiTemplateParameter parameter = new ApiTemplateParameter(typeDefinitionInfo, finalReplacedPath.NameSpacePath, data.ControllerName, data.EntityName, data.PluralName, null, data.IsMethodGeneration == "true");
        ...
        private static ProcessResult ProcessControllerTemplate(ApiTemplateParameter templateParameter, TypeDefinitionInfo typeDefinitionInfo)
        {
            ...
            ICodeTemplate codeTemplate = new ControllerWithRepository(parameter);
            ...
            var func = () =>
            {
                if (TemplateToUse.SwitchFlag == TemplateType.T4)
                    ...
                    return StaticTemplateProcessor.Process(TypeOfTemplate.ControllerWithRepository, parameter);
            };
    ...
    public class AttributeMetaDataRepoController : AttributeMetaData
    {
