...
namespace Restarted.Generators.FeatureProcessors.Controllers
{
    public class ControllerRepoService
    {
        ...
        public static List<string> Process(TypeDefinitionInfo typeDefinitionInfo, GeneratorContext generatorContext, AttributeMetaDataRepoController data)
        {
            ...
            ApiTemplateParameter parameter = new ApiTemplateParameter(typeDefinitionInfo, finalReplacedPath.NameSpacePath, data.ControllerName,  data.EntityName, data.PluralName,null);
