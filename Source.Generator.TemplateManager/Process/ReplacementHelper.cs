            ...
            return new Dictionary<string, string>()
                  {
                    { PlaceholderConstants.NameSpace, param.PreferredNameSpace},
                    { PlaceholderConstants.Name, param.SourceFileName},
                    { PlaceholderConstants.ActionMethodsGetBodies, ParameterHelper.ActionMethodsGetBodies(parameter) },
                    { PlaceholderConstants.ActionMethodsPostBodies, ParameterHelper.ActionMethodsPostBodies(parameter) },
                    { PlaceholderConstants.ActionMethodsPutBodies, ParameterHelper.ActionMethodsPutBodies(parameter) },
                    { PlaceholderConstants.ActionMethodsDeleteBodies, ParameterHelper.ActionMethodsDeleteBodies(parameter) }
                  };
        }
        //{@NameSpace}
        //{@Name}
